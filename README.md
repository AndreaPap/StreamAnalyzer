...
Its purpose is to calculate the information carried by the new stream with respect to prior knowledge: I[ New | Prior ] .

This is done by calculating:
-log2( P( New | Prior ) ), where P( New | Prior ) is assumed to be equal to Prod_i ( P_prior_i( New_i ) ).
